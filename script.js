...
function submit1() {
  uncheck();
  addNotesOutside("People Notes: ", myDIV.textContent);
  addNotesDr("Organization Notes: ", myDIV2.textContent);
  addNotesPUW("Product Notes: ", myDIV3.textContent);
  addNotesProd("Direction Notes: ", myDIV4.textContent);
